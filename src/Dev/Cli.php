...
class Cli {
    ...
    **/
     ...
     * 
    **/
    public function addCommands(array $list){
        $list = array_map('trim', $list);
    ...
    */
    public function handle()
    {
        ...
        if(PHP_SAPI == 'cli'){
            ...
            try {
                // Access to function
                $handle_func = call_user_func_array([$object, $this->defaultMethod()], []);

                if(array_key_exists($function, $handle_func)){
                    // Acess to target function
                    call_user_func_array([$object, $handle_func[$function]], $this->parms());
                }else{
    ...
    */
    public function call()
    {
        ...
        try {
            // Access to function
            $handle_func = call_user_func_array([$object, $this->getDefaultMethod()], []);
            if(array_key_exists($function, $handle_func)){
                // Acess to target function
