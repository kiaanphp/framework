...
|---------------------------------------------------
*/
namespace Kiaan\Contact\Socket\Addons\React\Dns\Protocol;
...
use Kiaan\Contact\Socket\Addons\React\Dns\Model\Record;
use Kiaan\Contact\Socket\Addons\React\Dns\Query\Query;
